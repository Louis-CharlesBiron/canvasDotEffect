...
const signatures = [
    ["_BaseObj"     , `constructor(pos, color, setupCB, loopCB, anchorPos, alwaysActive)`, `constructor(pos=[0,0], color="aliceblue", setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null)`],
    ...
    ["_Obj"         , `constructor(pos, radius, color, setupCB, loopCB, anchorPos, alwaysActive)`, `constructor(pos=[0,0], radius=5, color="aliceblue", setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null)`],
    ...
    ["AudioDisplay" , `new AudioDisplay(source, pos, color, binCB, sampleCount, disableAudio, offsetPourcent, errorCB, setupCB, loopCB, anchorPos, alwaysActive)`, `new AudioDisplay(source, pos=[0,0], color="aliceblue", binCB=AudioDisplay.DEFAULT_BINCB, sampleCount=64, disableAudio=false, offsetPourcent=0, errorCB, setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null)`],
    ["Dot"          , `new Dot(pos, radius, color, setupCB, anchorPos, alwaysActive, disablePathCaching)`, `new Dot(pos=[0,0], radius=5, color="aliceblue", setupCB=null, anchorPos=null, alwaysActive=null, disablePathCaching=false)`],
    ["FilledShape"  , `new FilledShape(fillColor, dynamicUpdates, pos, dots, radius, color, limit, drawEffectCB, ratioPosCB, setupCB, loopCB, anchorPos, alwaysActive, fragile)`, `new FilledShape(fillColor, dynamicUpdates=false, pos=[0,0], dots=[], radius=5, color="aliceblue", limit=100, drawEffectCB, ratioPosCB, setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null, fragile=false)`],
    ["Grid"         , `new Grid(keys, gaps, spacing, source, pos, radius, color, limit, drawEffectCB, ratioPosCB, setupCB, loopCB, anchorPos, alwaysActive, fragile)`, `new Grid(keys="", gaps=[10,10], spacing=Grid.DEFAULT_SPACING(this), source=GridAssets.DEFAULT_SOURCE, pos=[0,0], radius=5, color="aliceblue", limit=100, drawEffectCB, ratioPosCB, setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null, fragile=false)`],
    ["ImageDisplay" , `new ImageDisplay(source, pos, size, errorCB, setupCB, loopCB, anchorPos, alwaysActive)`, `new ImageDisplay(source, pos=[0,0], size, errorCB, setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null)`],
    ["Shape"        , `new Shape(pos, dots, radius, color, limit, drawEffectCB, ratioPosCB, setupCB, loopCB, anchorPos, alwaysActive, fragile)`, `new Shape(pos=[0,0], dots=[], radius=5, color="aliceblue", limit=100, drawEffectCB, ratioPosCB, setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null, fragile=false)`],
    ["TextDisplay"  , `new TextDisplay(text, pos, color, textStyles, drawMethod, maxWidth, setupCB, loopCB, anchorPos, alwaysActive)`, `new TextDisplay(text="", pos=[0,0], color="aliceblue", textStyles, drawMethod="FILL", maxWidth=undefined, setupCB=null, loopCB=null, anchorPos=null, alwaysActive=null)`],
